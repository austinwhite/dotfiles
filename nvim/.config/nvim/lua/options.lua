...
opt.number = true                                   -- use absolute line number for current line
...
opt.undodir = fn.stdpath('config')..'/undo'         -- where to store undo file
opt.termguicolors = true                            -- true color
opt.numberwidth = 5                                 -- number column width
...
wo.signcolumn = "yes"                               -- show sign column at all times
opt.shortmess = 'I'                                 -- hide welcome message
